...
@section('title', 'Tambah Berkas Arsip')
...
@section('content')
    <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold" style="color: #008e3c;">
                        <i class="fas fa-plus-circle mr-2"></i>Tambah Berkas Arsip
                    </h2>
                    <p class="text-gray-600 text-sm mt-1">Buat berkas/map baru untuk pengelompokan arsip</p>
                </div>
        ...
        <!-- Form -->
        <form action="{{ route('berkas-arsip.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="kode_klasifikasi_id" required
                            ...
                            @foreach($klasifikasiList as $klasifikasi)
                                <option value="{{ $klasifikasi->id }}" {{ old('kode_klasifikasi_id') == $klasifikasi->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_berkas" value="{{ old('nomor_berkas', $nomorBerkasSuggestion) }}"
                        ...
                        @error('nomor_berkas')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Biarkan default untuk auto-generate</p>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="uraian_berkas" rows="3" required
                            ...
                            placeholder="Deskripsi isi berkas...">{{ old('uraian_berkas') }}</textarea>
                        @error('uraian_berkas')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="kurun_waktu" value="{{ old('kurun_waktu') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="unit_kerja" value="{{ old('unit_kerja') }}" required list="unit-kerja-list"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="status_arsip" required
                            ...
                            <option value="Aktif" {{ old('status_arsip') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                            <option value="Inaktif" {{ old('status_arsip') == 'Inaktif' ? 'selected' : '' }}>Inaktif</option>
                            <option value="Permanen" {{ old('status_arsip') == 'Permanen' ? 'selected' : '' }}>Permanen
                            </option>
                        </select>
                        @error('status_arsip')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <select name="lokasi_arsip_id"
                            ...
                            @foreach($lokasiList as $lokasi)
                                <option value="{{ $lokasi->id }}" {{ old('lokasi_arsip_id') == $lokasi->id ? 'selected' : '' }}>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center justify-end space-x-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i>Simpan Berkas
                    </button>
                </div>
            </div>
        </form>

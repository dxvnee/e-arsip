...
@section('title', 'Edit Kode Klasifikasi Arsip')
...
<div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold" style="color: #008e3c;">
                    <i class="fas fa-edit mr-2"></i>Edit Kode Klasifikasi
                </h2>
                <p class="text-gray-600 text-sm mt-1">Edit kode klasifikasi: <strong>{{ $klasifikasiArsip->kode_klasifikasi }}</strong></p>
            </div>
            <a href="{{ route('klasifikasi-arsip.index') }}" class="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
    ...
    <!-- Form -->
    <form action="{{ route('klasifikasi-arsip.update', $klasifikasiArsip) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode_klasifikasi" value="{{ old('kode_klasifikasi', $klasifikasiArsip->kode_klasifikasi) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="nama_klasifikasi" value="{{ old('nama_klasifikasi', $klasifikasiArsip->nama_klasifikasi) }}" required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="3"
                              ...
                              placeholder="Masukkan deskripsi klasifikasi (opsional)">{{ old('deskripsi', $klasifikasiArsip->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="retensi_aktif" value="{{ old('retensi_aktif', $klasifikasiArsip->retensi_aktif) }}" required min="0" max="100"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="retensi_inaktif" value="{{ old('retensi_inaktif', $klasifikasiArsip->retensi_inaktif) }}" required min="0" max="100"
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <label class="flex items-center p-3 border rounded-lg cursor-pointer transition-all {{ old('nasib_akhir', $klasifikasiArsip->nasib_akhir) === 'musnah' ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-red-300' }}">
                            <input type="radio" name="nasib_akhir" value="musnah"
                                   class="mr-2 text-red-600 focus:ring-red-500"
                                   {{ old('nasib_akhir', $klasifikasiArsip->nasib_akhir) === 'musnah' ? 'checked' : '' }}>
                            <span class="text-sm">
                                <i class="fas fa-fire text-red-500 mr-1"></i> Musnah
                            </span>
                        </label>
                        <label class="flex items-center p-3 border rounded-lg cursor-pointer transition-all {{ old('nasib_akhir', $klasifikasiArsip->nasib_akhir) === 'permanen' ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:border-blue-300' }}">
                            <input type="radio" name="nasib_akhir" value="permanen"
                                   class="mr-2 text-blue-600 focus:ring-blue-500"
                                   {{ old('nasib_akhir', $klasifikasiArsip->nasib_akhir) === 'permanen' ? 'checked' : '' }}>
                            <span class="text-sm">
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-700">
                        ...
                        <ul class="mt-1 list-disc list-inside space-y-1">
                            ...
                            <li><strong>Retensi Inaktif:</strong> Masa penyimpanan arsip di records center/pusat arsip</li>
                ...
                <div class="flex items-center">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" value="1"
                               {{ old('is_active', $klasifikasiArsip->is_active) ? 'checked' : '' }}
    ...
    <div class="mt-4 text-center text-sm text-gray-500">
        Terakhir diperbarui: {{ $klasifikasiArsip->updated_at->format('d F Y, H:i') }} WIB
    </div>
</div>
@endsection

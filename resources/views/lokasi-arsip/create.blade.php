...
@section('title', 'Tambah Lokasi Arsip')
...
@section('content')
    <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold" style="color: #008e3c;">
                        <i class="fas fa-plus-circle mr-2"></i>Tambah Lokasi Arsip
                    </h2>
                    <p class="text-gray-600 text-sm mt-1">Input lokasi penyimpanan arsip fisik</p>
                </div>
        ...
        <!-- Form -->
        <form action="{{ route('lokasi-arsip.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="gedung" value="{{ old('gedung') }}" required list="gedung-list"
                    ...
                    <div>
                        ...
                        <input type="text" name="ruang" value="{{ old('ruang') }}" required list="ruang-list"
                    ...
                    <div>
                        ...
                        <input type="text" name="rak" value="{{ old('rak') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="boks" value="{{ old('boks') }}" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="kapasitas" value="{{ old('kapasitas', 0) }}" min="0" max="9999"
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_lokasi" value="{{ old('kode_lokasi') }}"
                        ...
                        @error('kode_lokasi')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Akan dibuat otomatis jika tidak diisi</p>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="3"
                            ...
                            placeholder="Keterangan tambahan tentang lokasi (opsional)">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div class="flex items-start">
                        ...
                        <div class="text-sm text-blue-700">
                            <p class="font-medium">Struktur Lokasi Arsip:</p>
                            <div class="mt-2 flex items-center space-x-2">
                                <span class="px-2 py-1 bg-blue-100 rounded text-xs font-medium">Gedung</span>
                                <i class="fas fa-arrow-right text-xs"></i>
                                <span class="px-2 py-1 bg-blue-100 rounded text-xs font-medium">Ruang</span>
                                <i class="fas fa-arrow-right text-xs"></i>
                                <span class="px-2 py-1 bg-blue-100 rounded text-xs font-medium">Rak</span>
                                <i class="fas fa-arrow-right text-xs"></i>
                                <span class="px-2 py-1 bg-blue-100 rounded text-xs font-medium">Boks</span>
                            </div>
                        </div>
                    </div>
                </div>
